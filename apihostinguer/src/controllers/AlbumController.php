...
class AlbumController
{
    ...
    public function comprarPacote(): void
    {
        ...
        try {
            ...
            $carteira = $this->db->fetchOne("SELECT usuario_id, saldo FROM bets_carteira WHERE usuario_id = ? FOR UPDATE", [$uid]);
            ...
            // Desconta o saldo
            $this->db->execute("UPDATE bets_carteira SET saldo = saldo - ? WHERE usuario_id = ?", [$precoPacote, $uid]);
